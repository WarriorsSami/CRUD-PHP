<?php 
  ...
  require_once ("Controllers/crudControllersOrd.php");
  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="container text-center">
          <h1 class="py-4 bg-dark text-light rounded"><i style="color: orange;" class="fab fa-apple fa-lg"></i> IT CRUD Panel - Order</h1>
          
          <br><br>
          <div class="d-flex justify-content-center">
              <form action="" method="post" class="w-50">
                  <div class="py-2">
                      <?php inputElement ('<i class="fa fa-id-badge fa-lg"></i>', 'ID', 'order_id', setId ()); ?>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col">
                          <div class="py-2">
                              <?php inputElement ('<i class="fa fa-user fa-lg"></i>', 'Customer ID', 'client_id', ''); ?>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="row">
                      <div class="col">
                          <div class="py-2">
                              <?php inputElement ('<i class="fab fa-microsoft fa-lg"></i>', 'Product ID', 'prod_id', ''); ?>
                          </div>
                      </div>
              ...
              <table class="table table-striped table-dark">
                  ...
                  <tbody id="tbody">
                      ...
                      <tr>
                          ...
                          <td data-id="<?php echo ($row['id']); ?>"><?php echo ($row['data_finalizare']); ?></td>
                          <td data-id="<?php echo ($row['id']); ?>"><?php echo ($row['client_id']); ?></td>
                          <td data-id="<?php echo ($row['id']); ?>"><?php echo ($row['produs_id']); ?></td>
    ...
    <script src="js_util/disp_ord.js"></script>
    ...
    <?php if (isset ($_SESSION['inserted'])) {
      ...
      <script>
              $(document).ready (function () {
                toastr.success ('New order inserted!');
              });
      </script>
    "); } ?>
    ...
    <?php if (isset ($_SESSION['failed-order'])) {
      unset ($_SESSION['failed-order']);
      echo ("
      <script>
              $(document).ready (function () {
                toastr.error ('Inexistent customer or product or even team!');
              });
      </script>
    "); } ?>
    ...
    <?php if (isset ($_SESSION['no-prod'])) {
      ...
      <script>
              $(document).ready (function () {
                toastr.error ('" . $_SESSION['no-prod'] . " is not available!');
              });
      </script>
    "); 
      unset ($_SESSION['no-prod']); } ?>

    <?php if (isset ($_SESSION['occupied-team'])) {
      echo ("
      <script>
              $(document).ready (function () {
                toastr.error ('" . $_SESSION['occupied-team'] . " team is already working on a " . $_SESSION['occ-proj'] . " project!');
              });
      </script>
    "); 
      unset ($_SESSION['occupied-team']); } ?>
