<?php 
    ...
    require_once ("Controllers/crudControllersEch.php");
  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="container text-center">
          <h1 class="py-4 bg-dark text-light rounded"><i style="color: orange;" class="fab fa-apple fa-lg"></i> IT CRUD Panel - Team</h1>
          ...
          <div class="d-flex justify-content-center">
              <form action="" method="post" class="w-50">
                  ...
                  <div class="py-2">
                      <?php inputElement ('<i class="fab fa-teamspeak fa-lg"></i>', 'Team Name', 'team_name', ''); ?>
                  </div>
    ...
    <script src="js_util/disp_ech.js"></script>
    ...
    <?php if (isset ($_SESSION['inserted'])) {
      ...
      <script>
              $(document).ready (function () {
                toastr.success ('New team inserted!');
              });
      </script>
    "); } ?>
