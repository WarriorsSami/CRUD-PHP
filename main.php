  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="container text-center">
          <h1 class="py-4 bg-dark text-light rounded"><i style="color: orange;" class="fab fa-apple fa-lg"></i> IT CRUD Panel - Customer</h1>
          
          <br><br>
          <div class="d-flex justify-content-center">
              <form action="" method="post" class="w-50">
                  <div class="py-2">
                      <?php inputElement ('<i class="fa fa-id-badge fa-lg"></i>', 'ID', 'client_id', setId ()); ?>
                  </div>

                  <div class="row">
                      <div class="col">
                          <div class="py-2">
                              <?php inputElement ('<i class="fa fa-user fa-lg"></i>', 'First Name', 'client_name', ''); ?>
                          </div>
                      </div>

                      <div class="col">
                          <div class="py-2">
                              <?php inputElement ('<i class="fa fa-users fa-lg"></i>', 'Last Name', 'client_surname', ''); ?>
                          </div>
                      </div>
                  </div>
                  
                  <div class="py-2">
                      <?php inputElement ('<i class="fa fa-envelope fa-lg"></i>', 'Email', 'client_email', ''); ?>
                  </div>

                  <div class="py-2">
                      <?php inputElement ('<i class="fa fa-address-book fa-lg"></i>', 'Address', 'client_adr', ''); ?>
                  </div>
                  ...
                  <tbody id="tbody">
                      <?php 
                          if (isset ($_POST['read'])) {
                              ...
                              if ($result) {
                                  $index = 0;
                                  while ($client = $result->fetch_assoc () and $index < 50) { 
                                    ++ $index; ?>

                      <tr>
                          <td data-id="<?php echo ($client['client_id']); ?>"><?php echo ($client['client_id']); ?></td>
                          <td data-id="<?php echo ($client['client_id']); ?>"><?php echo ($client['prenume']); ?></td>
                          <td data-id="<?php echo ($client['client_id']); ?>"><?php echo ($client['nume']); ?></td>
                          <td data-id="<?php echo ($client['client_id']); ?>"><?php echo ($client['email']); ?></td>
                          <td data-id="<?php echo ($client['client_id']); ?>"><?php echo ($client['adresa']); ?></td>
                          <td><i class="fa fa-edit btnedit" data-id="<?php echo ($client['client_id']); ?>"></i></td>
                      </tr>
    ...
    <script src="js_util/disposal.js"></script>
