<?php 
  ...
  require_once ("Controllers/crudControllersProd.php");
  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="container text-center">
          <h1 class="py-4 bg-dark text-light rounded"><i style="color: orange;" class="fab fa-apple fa-lg"></i> IT CRUD Panel - Product</h1>
          
          <br><br>
          <div class="d-flex justify-content-center">
              <form action="" method="post" class="w-50">
                  <div class="py-2">
                      <?php inputElement ('<i class="fa fa-id-badge fa-lg"></i>', 'ID', 'id', setId ()); ?>
                  </div>

                  <div class="py-2">
                      <?php inputElement ('<i class="fab fa-microsoft fa-lg"></i>', 'Product Name', 'prod_name', ''); ?>
                  </div>

                  <div class="py-2">
                      <?php textareaElement ('<i class="fa fa-info-circle fa-2x"></i>', 'Product Specifications', 'prod_task'); ?>
                  </div>

                  <div class="py-2">
                      <?php inputElement ('<i class="fa fa-check-circle fa-lg"></i>', 'Disponibility', 'prod_disp', ''); ?>
                  </div>
              ...
              <table class="table table-striped table-dark">
                  ...
                  <tbody id="tbody">
                      ...
                      <tr>
                          ...
                          <td data-id="<?php echo ($row['id']); ?>"><?php echo ($row['descriere']); ?></td>
                          <td data-id="<?php echo ($row['id']); ?>"><?php echo ($row['cerinte']); ?></td>
                          <td data-id="<?php echo ($row['id']); ?>"><?php echo ($row['disponibil']); ?></td>
                    ...
                    <div class="modal-body">
                        <ul class="list-group" style="list-style-type: none;">
                            ...
                            <a class="btn btn-success" href="general.php">
                                <li>
                                    <i class="fab fa-globe"></i> General
                                </li>
                            </a>
                        </ul>
                    </div>
    ...
    <script src="js_util/disp_prod.js"></script>
