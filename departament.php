<?php 
  ...
  require_once ("Controllers/crudControllersDep.php");
  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="container text-center">
          <h1 class="py-4 bg-dark text-light rounded"><i style="color: orange;" class="fab fa-apple fa-lg"></i> IT CRUD Panel - Department</h1>
          ...
          <div class="d-flex justify-content-center">
              <form action="" method="post" class="w-50">
                  ...
                  <div class="py-2">
                      <?php inputElement ('<i class="fa fa-building fa-lg"></i>', 'Department Name', 'dep_name', ''); ?>
                  </div>
              ...
              <table class="table table-striped table-dark">
                  ...
                  <tbody id="tbody">
                      ...
                      <tr>
                          ...
                          <td data-id="<?php echo ($row['id']); ?>"><?php echo ($row['denumire']); ?></td>
    ...
    <script src="js_util/dep_disp.js"></script>
    ...
    <?php if (isset ($_SESSION['inserted'])) {
      ...
      <script>
              $(document).ready (function () {
                toastr.success ('New department inserted!');
              });
      </script>
    "); } ?>
